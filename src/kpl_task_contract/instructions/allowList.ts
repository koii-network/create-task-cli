...
const DataLayout = struct<Data>([u8('instruction'), u8('is_allowlisted')]);
...
export async function allowListInstruction(
  ...
  console.log(
    'managerAccountDataHolder: ',
    managerAccountDataHolder.toBase58(),
  );
