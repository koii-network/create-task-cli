...
export async function uploadDistributionListInstruction(
  params: UploadDistributionParams,
  accounts: Accounts,
  ...
  DataLayout.encode(
    {
      ...
      instruction_data: Uint8Array.from([
        ...params.header,
        ...new TextEncoder().encode(
          padStringWithSpaces(params.instruction_data, 508),
        ),
      ]),
      round: params.round,
    },
